...
import {controversyRouter} from '../server/controversy/router';
import {reflectionRouter} from '../server/reflection/router';
...
app.use('/api/controversies', controversyRouter);
